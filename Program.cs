...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<KidsMealDbContext>(opt => opt.UseNpgsql(builder.Configuration["DbConnectionString"] ?? builder.Configuration.GetConnectionString("DbConnectionString"))
